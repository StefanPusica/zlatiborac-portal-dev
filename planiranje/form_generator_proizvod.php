<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <blockquote>
                <p></p>
                <p>Generator naloga proizvoda</p>
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-success btn-sm" id="save" style=""><span class="glyphicon glyphicon-remove-circle"></span> Generiši</button>
...
<script>
    $(function () {
        ...
        $('#save').click(function () {
            ...
            form2post("<?= $proplaniranje_url; ?>/generisi_naloge_proizvoda", {plan: <?= $plan; ?>, proizvod: <?= $proizvod; ?>, pakovanje: <?= $pakovanje; ?>}, function (status, data) {
                if (!status) {
                    $("#loader").hide();
                    $('#close').show();
                    $('#save').show();
