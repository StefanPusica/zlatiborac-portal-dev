        ...
        <div class="modal-body" style="height: 440px;">
            ...
            <form class="form-horizontal" role="form" name="frmIzbor" id="frmIzbor">
                ...
                <div class="form-group" style="margin-top: -8px;">
                    ...
                    <div class="" style="width: 300px; padding-left: 15px; float: left;">
                        <label for="proizvod" class="control-label">Proizvod</label>
                        <select id="sirovProizvodSel" name="proizvod" class="form-control input-sm" >
                            <option value='0'>Izbor proizvoda</option>
                            <?
                            foreach ($arrProizvod as $key => $o) {
                                $sel = ''; //$kupac == $o->sifra ? "selected='selected'" : "";
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#saveForm").click(function () {
            ...
            form2post("<?= $proplaniranje_url; ?>/save_sirov_proizvod_artikli", args, function (status, data) {
                oBlendaForm.hide();
                if (!status) {
    ...
    function contentSirovProizvodLoader() {
        var o = $("#frmContentProizvod");

        var args = {plan: <?= $plan; ?>, proizvod: $("#sirovProizvodSel").val()};
        urlContent(o, "<?= $proplaniranje_url; ?>/xIzborSirovogProizvoda", args, function () {
        });
    }
